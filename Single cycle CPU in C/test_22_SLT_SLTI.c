...
int main()
{
	...
	// slti  $s6, $s0, 1234
	// slti  $s7, $s1, 123
	cpuState.instMemory[0x102] = SLT (S_REG(4), S_REG(0), S_REG(1));
	cpuState.instMemory[0x103] = SLT (S_REG(5), S_REG(1), S_REG(0));
	cpuState.instMemory[0x104] = SLTI(S_REG(6), S_REG(0), 1234);
	cpuState.instMemory[0x105] = SLTI(S_REG(7), S_REG(1), 123);
